...
| FR-9, FR-13 | 0.11.0 |
| FR-11 | Events, evidence files, generated text artifacts: 0.11.0. Notes: 0.14.0. Status files and Mem0 as read by `query_context` and `search_mem0_live`: 0.15.0. Snapshot excerpts, imports: planned |
